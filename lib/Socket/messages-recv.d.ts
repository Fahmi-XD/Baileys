...
export declare const makeMessagesRecvSocket: (config: SocketConfig) => {
    ...
    refreshMediaConn: (forceGet?: boolean) => Promise<import("@whiskeysockets/baileys/src/Types/Message").MediaConnInfo>;
    ...
    getUSyncDevices: (jids: string[], useCache: boolean, ignoreZeroDevices: boolean) => Promise<import("@whiskeysockets/baileys/src/WABinary/jid-utils").JidWithDevice[]>;
    updateMediaMessage: (message: proto.IWebMessageInfo) => Promise<proto.IWebMessageInfo>;
    sendMessage: (jid: string, content: import("@whiskeysockets/baileys/src/Types/Message").AnyMessageContent, options?: import("@whiskeysockets/baileys/src/Types/Message").MiscMessageGenerationOptions) => Promise<proto.WebMessageInfo | undefined>;
