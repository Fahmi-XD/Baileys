    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (typeof content === 'object' &&
                ...
                else if ((options.isAi || options.isAi == undefined) && !(0, WABinary_1.isJidGroup)(jid)) {
                    additionalNodes.push({
                        attrs: {
                            biz_bot: '1'
                        },
                ...
                await relayMessage(jid, {
                    ...fullMsg.message,
                    ...((options.isAi || options.isAi == undefined) && !(0, WABinary_1.isJidGroup)(jid) ? { messageContextInfo: {
                            messageSecret: node_crypto_1.default.randomBytes(32),
