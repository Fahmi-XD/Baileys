...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, messageContent, { messageId: msgId, participant, additionalNodes, additionalAttributes, useUserDevicesCache, cachedGroupMetadata, statusJidList }) => {
        var _a;
        const gens = await (0, Utils_1.generateWAMessageFromContent)(jid, {
            ...messageContent,
