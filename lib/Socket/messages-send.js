...
var ListType = WAProto_1.default.WAE2E.Message.ListMessage.ListType;
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalNodes, additionalAttributes, useUserDevicesCache, cachedGroupMetadata, statusJidList }) => {
        var _a;
        ...
        await authState.keys.transaction(async () => {
            ...
            if (isGroup || isStatus) {
                ...
                if ((_a = message === null || message === void 0 ? void 0 : message.protocolMessage) === null || _a === void 0 ? void 0 : _a.editedMessage) {
                    msgId = (_b = message.protocolMessage.key) === null || _b === void 0 ? void 0 : _b.id;
                    message = message.protocolMessage.editedMessage;
                }
                if (((_c = message === null || message === void 0 ? void 0 : message.protocolMessage) === null || _c === void 0 ? void 0 : _c.type) ===
                    WAProto_1.default.WAE2E.Message.ProtocolMessage.Type.REVOKE) {
                    msgId = (_d = message.protocolMessage.key) === null || _d === void 0 ? void 0 : _d.id;
                    message = {};
                }
                const patched = await patchMessageBeforeSending(message, []);
                const bytes = WAProto_1.default.WAE2E.Message.encode(patched).finish();
                binaryNodeContent.push({
                    tag: "plaintext",
            ...
            if (!isNewsletter) {
                if (message &&
                    ...
                    message.viewOnceMessage.message.interactiveMessage || ((_h = (_g = message.viewOnceMessage) === null || _g === void 0 ? void 0 : _g.message) === null || _h === void 0 ? void 0 : _h.buttonsMessage) || message.buttonsMessage) {
    ...
    return {
                    ...
                    if (result) {
                        if (result.error) {
                            ...
                            try {
                                ...
                                if (media.result !== WAProto_1.default.WAMmsRetry.MediaRetryNotification.ResultType.SUCCESS) {
                                    const resultStr = WAProto_1.default.WAMmsRetry.MediaRetryNotification.ResultType[media.result];
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (typeof content === 'object' &&
                ...
                // 	} : {})
                // }, { userJid: jid });
                if (!(0, WABinary_1.isJidGroup)(jid) && !((_c = fullMsg.message) === null || _c === void 0 ? void 0 : _c.buttonsMessage) && !((_f = (_e = (_d = fullMsg.message) === null || _d === void 0 ? void 0 : _d.viewOnceMessage) === null || _e === void 0 ? void 0 : _e.message) === null || _f === void 0 ? void 0 : _f.buttonsMessage) && !(0, WABinary_1.isJidNewsletter)(jid) && (content === null || content === void 0 ? void 0 : content.ai)) {
