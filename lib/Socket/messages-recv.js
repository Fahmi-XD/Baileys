...
const makeMessagesRecvSocket = (config) => {
        ...
        await Promise.all([
            processingMutex.mutex(async () => {
                ...
                if (typeof status !== 'undefined' &&
                    ...
                    status > WAProto_1.default.WAWeb.WebMessageInfo.Status.DELIVERY_ACK ||
                        !isNodeFromMe)) {
                    if ((0, WABinary_1.isJidGroup)(remoteJid) || (0, WABinary_1.isJidStatusBroadcast)(remoteJid)) {
                        if (attrs.participant) {
                            const updateKey = status === WAProto_1.default.WAWeb.WebMessageInfo.Status.DELIVERY_ACK ? 'receiptTimestamp' : 'readTimestamp';
        ...
        await Promise.all([
            processingMutex.mutex(async () => {
                ...
                if (msg) {
                    ...
                    const fullMsg = WAProto_1.default.WAWeb.WebMessageInfo.fromObject(msg);
    ...
    const handleMessage = async (node) => {
        ...
        // console.log("Realize")
        // console.log(msg)
        if (((_b = (_a = msg.message) === null || _a === void 0 ? void 0 : _a.protocolMessage) === null || _b === void 0 ? void 0 : _b.type) === WAProto_1.default.WAE2E.Message.ProtocolMessage.Type.SHARE_PHONE_NUMBER) {
        ...
        await Promise.all([
            processingMutex.mutex(async () => {
                ...
                if (msg.messageStubType === WAProto_1.default.WAWeb.WebMessageInfo.StubType.CIPHERTEXT) {
    ...
    ev.on('call', ([call]) => {
        ...
        if (call.status === 'timeout' || (call.status === 'offer' && call.isGroup)) {
            ...
            const protoMsg = WAProto_1.default.WAWeb.WebMessageInfo.fromObject(msg);
