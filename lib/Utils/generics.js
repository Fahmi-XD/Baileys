...
const encodeWAMessage = (message) => ((0, exports.writeRandomPadMax16)(WAProto_1.default.WAE2E.Message.encode(message).finish()));
...
const STATUS_MAP = {
    'played': WAProto_1.default.WAWeb.WebMessageInfo.Status.PLAYED,
    'read': WAProto_1.default.WAWeb.WebMessageInfo.Status.READ,
    'read-self': WAProto_1.default.WAWeb.WebMessageInfo.Status.READ
};
/**
...
const getStatusFromReceiptType = (type) => {
    ...
    if (typeof type === 'undefined') {
        return WAProto_1.default.WAWeb.WebMessageInfo.Status.DELIVERY_ACK;
    }
    return status;
};
