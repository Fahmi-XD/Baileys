...
const getWAUploadToServer = ({ customUploadHosts, fetchAgent, logger, options }, refreshMediaConn) => {
    return async (stream, { mediaType, newsletter, fileEncSha256B64, timeoutMs }) => {
        var _a, _b;
...
const encryptMediaRetryRequest = (key, mediaKey, meId) => {
    ...
    const recpBuffer = WAProto_1.default.WAMmsRetry.ServerErrorReceipt.encode(recp).finish();
...
const decryptMediaRetryData = ({ ciphertext, iv }, mediaKey, msgId) => {
    ...
    return WAProto_1.default.WAMmsRetry.MediaRetryNotification.decode(plaintext);
};
exports.decryptMediaRetryData = decryptMediaRetryData;
const getStatusCodeForMediaRetry = (code) => MEDIA_RETRY_STATUS_MAP[code];
exports.getStatusCodeForMediaRetry = getStatusCodeForMediaRetry;
const MEDIA_RETRY_STATUS_MAP = {
    [WAProto_1.default.WAMmsRetry.MediaRetryNotification.ResultType.SUCCESS]: 200,
    [WAProto_1.default.WAMmsRetry.MediaRetryNotification.ResultType.DECRYPTION_ERROR]: 412,
    [WAProto_1.default.WAMmsRetry.MediaRetryNotification.ResultType.NOT_FOUND]: 404,
    [WAProto_1.default.WAMmsRetry.MediaRetryNotification.ResultType.GENERAL_ERROR]: 418,
};
