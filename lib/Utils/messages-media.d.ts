 ...
 */
export declare const encryptMediaRetryRequest: (key: proto.WAProtocol.IMessageKey, mediaKey: Buffer | Uint8Array, meId: string) => BinaryNode;
...
export declare const decryptMediaRetryData: ({ ciphertext, iv }: {
    ciphertext: Uint8Array;
    iv: Uint8Array;
}, mediaKey: Uint8Array, msgId: string) => proto.WAMmsRetry.MediaRetryNotification;
