...
export declare const getKeyAuthor: (key: proto.WAProtocol.IMessageKey | undefined | null, meId?: string) => string;
export declare const writeRandomPadMax16: (msg: Uint8Array) => Buffer;
export declare const unpadRandomMax16: (e: Uint8Array | Buffer) => Uint8Array;
export declare const encodeWAMessage: (message: proto.WAE2E.IMessage) => Buffer;
 ...
 */
export declare const getStatusFromReceiptType: (type: string | undefined) => proto.WAWeb.WebMessageInfo.Status;
/**
