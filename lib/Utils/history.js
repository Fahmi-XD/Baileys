...
const downloadHistory = async (msg, options) => {
    ...
    const syncData = WAProto_1.default.WAHistorySync.HistorySync.decode(buffer);
    return syncData;
};
...
const processHistoryMessage = (item) => {
    ...
    switch (item.syncType) {
        case WAProto_1.default.WAHistorySync.HistorySync.HistorySyncType.INITIAL_BOOTSTRAP:
        case WAProto_1.default.WAHistorySync.HistorySync.HistorySyncType.RECENT:
        case WAProto_1.default.WAHistorySync.HistorySync.HistorySyncType.FULL:
            ...
            break;
        case WAProto_1.default.WAHistorySync.HistorySync.HistorySyncType.PUSH_NAME:
