...
function decryptPollVote({ encPayload, encIv }, { pollCreatorJid, pollMsgId, pollEncKey, voterJid, }) {
    ...
    return WAProto_1.default.WAE2E.Message.PollVoteMessage.decode(decrypted);
...
const processMessage = async (message, { shouldProcessHistoryMsg, ev, creds, keyStore, logger, options, getMessage }) => {
    ...
    if (protocolMsg) {
        switch (protocolMsg.type) {
            case WAProto_1.default.WAE2E.Message.ProtocolMessage.Type.HISTORY_SYNC_NOTIFICATION:
                ...
                break;
            case WAProto_1.default.WAE2E.Message.ProtocolMessage.Type.APP_STATE_SYNC_KEY_SHARE:
                ...
                break;
            case WAProto_1.default.WAE2E.Message.ProtocolMessage.Type.REVOKE:
                ...
                break;
            case WAProto_1.default.WAE2E.Message.ProtocolMessage.Type.EPHEMERAL_SETTING:
                Object.assign(chat, {
                    ephemeralSettingTimestamp: (0, generics_1.toNumber)(message.messageTimestamp),
                    ephemeralExpiration: protocolMsg.ephemeralExpiration || null
                });
                break;
            case WAProto_1.default.WAE2E.Message.ProtocolMessage.Type.PEER_DATA_OPERATION_REQUEST_RESPONSE_MESSAGE:
                ...
                if (response) {
                    ...
                    for (const result of peerDataOperationResult) {
                        ...
                        if (retryResponse) {
                            const webMessageInfo = WAProto_1.default.WAWeb.WebMessageInfo.decode(retryResponse.webMessageInfoBytes);
                            ev.emit('messages.update', [
